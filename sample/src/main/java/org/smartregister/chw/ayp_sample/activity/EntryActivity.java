...
public class EntryActivity extends SecuredActivity implements View.OnClickListener, BaseAypVisitContract.VisitView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.ayp_parenting_client_profile).setOnClickListener(this);
        findViewById(R.id.ayp_facility_biomedical_visit).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ayp_in_school_group_profile:
                ...
                break;
            case R.id.ayp_parenting_client_profile:
                AypParentingMemberProfileActivity.startMe(this, "12345");
                break;
