package org.smartregister.chw.ayp_sample.repository;
...
import org.smartregister.chw.ayp_sample.BuildConfig;
import org.smartregister.chw.ayp_sample.application.SampleApplication;
...
public class SampleRepository extends Repository {
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        AypLibrary.getInstance().visitRepository().createTable(database);
        AypLibrary.getInstance().visitDetailsRepository().createTable(database);
