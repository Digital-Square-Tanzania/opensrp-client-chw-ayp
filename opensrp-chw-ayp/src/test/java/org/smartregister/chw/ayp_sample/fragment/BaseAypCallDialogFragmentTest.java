...
@PrepareForTest(BaseAypCallDialogFragment.class)
public class BaseAypCallDialogFragmentTest {
    @Spy
    public BaseAypCallDialogFragment baseTestCallDialogFragment;
    ...
    @Mock
    public MemberObject aypMemberObject;

    @Before
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        Whitebox.setInternalState(BaseAypCallDialogFragment.class, "MEMBER_OBJECT", aypMemberObject);
    }
    ...
    public void setCallTitleFamilyHead() throws Exception {
        ...
        Mockito.when(aypMemberObject.getBaseEntityId()).thenReturn("123456");
        Mockito.when(aypMemberObject.getFamilyHead()).thenReturn("123456");
    ...
    public void setCallTitleCareGiver() throws Exception {
        ...
        Mockito.when(aypMemberObject.getBaseEntityId()).thenReturn("123456");
        Mockito.when(aypMemberObject.getPrimaryCareGiver()).thenReturn("123456");
    ...
    public void setCallTitle() throws Exception {
        ...
        Mockito.when(aypMemberObject.getBaseEntityId()).thenReturn("1");
        Mockito.when(aypMemberObject.getFamilyHead()).thenReturn("123456");

        Mockito.when(viewGroup.findViewById(view.getId())).thenReturn(textView);

        Whitebox.invokeMethod(baseTestCallDialogFragment, "setCallTitle", viewGroup, view.getId(), "message");
        Assert.assertEquals("message Ayp Client", textView.getText());
    }

    @Test(expected = Exception.class)
    public void initUI() throws Exception {
        Mockito.when(aypMemberObject.getPhoneNumber()).thenReturn("123456789");
