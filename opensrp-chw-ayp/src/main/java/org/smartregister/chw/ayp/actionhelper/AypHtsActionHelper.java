...
public class AypHtsActionHelper implements BaseAypVisitAction.aypVisitActionHelper {
    ...
    public AypHtsActionHelper(Context context, MemberObject memberObject) {
    ...
    public String getPreProcessed() {
        try {
            ...
            String is_client_diagnosed_with_any = AypMedicalHistoryActionHelper.is_client_diagnosed_with_any;
            String any_complaints = AypMedicalHistoryActionHelper.any_complaints;
            String known_allergies = AypMedicalHistoryActionHelper.known_allergies;
            String any_hematological_disease_symptoms = AypMedicalHistoryActionHelper.any_hematological_disease_symptoms;
            String complications_previous_surgical = AypMedicalHistoryActionHelper.complications_previous_surgical;
            String type_of_blood_for_glucose_test = AypMedicalHistoryActionHelper.type_of_blood_for_glucose_test;
            String blood_for_glucose = AypMedicalHistoryActionHelper.blood_for_glucose;
            String blood_for_glucose_test = AypMedicalHistoryActionHelper.blood_for_glucose_test;
            String diagonised_others = AypMedicalHistoryActionHelper.client_diagnosed_other;
            String genital_examination = AypPhysicalExamActionHelper.genital_examination;
            String diastolic = AypPhysicalExamActionHelper.diastolic;
            String systolic = AypPhysicalExamActionHelper.systolic;
