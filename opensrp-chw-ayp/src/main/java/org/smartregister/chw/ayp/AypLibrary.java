package org.smartregister.chw.ayp;
...
public class AypLibrary {
    private static AypLibrary instance;
    ...
    public void setSubmitOnSave(boolean submitOnSave) {
        AypLibrary.submitOnSave = submitOnSave;
    }
    ...
    public static void init(Context context, Repository repository, int applicationVersion, int databaseVersion) {
        if (instance == null) {
            instance = new AypLibrary(context, repository, applicationVersion, databaseVersion);
        }
    }

    public static AypLibrary getInstance() {
        if (instance == null) {
    ...
    private AypLibrary(Context contextArg, Repository repositoryArg, int applicationVersion, int databaseVersion) {
