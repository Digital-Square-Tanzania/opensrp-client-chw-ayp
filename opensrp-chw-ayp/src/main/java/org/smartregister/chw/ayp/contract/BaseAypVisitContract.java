...
public interface BaseAypVisitContract {
    interface View extends VisitView {
        ...
        void startForm(BaseAypVisitAction aypHomeVisitAction);

        void startFormActivity(JSONObject jsonForm);

        void startFragment(BaseAypVisitAction aypHomeVisitAction);
        ...
        Map<String, BaseAypVisitAction> getaypVisitActions();
        ...
        void initializeActions(LinkedHashMap<String, BaseAypVisitAction> map);
    ...
    interface Interactor {
        ...
        void submitVisit(boolean editMode, String memberID, Map<String, BaseAypVisitAction> map, InteractorCallBack callBack);
    }
    ...
    interface InteractorCallBack {
        ...
        void preloadActions(LinkedHashMap<String, BaseAypVisitAction> map);
