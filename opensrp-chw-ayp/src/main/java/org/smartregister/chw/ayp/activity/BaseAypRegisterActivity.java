...
public class BaseAypRegisterActivity extends BaseRegisterActivity implements AypRegisterContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FORM_NAME = getIntent().getStringExtra(Constants.ACTIVITY_PAYLOAD.AYP_FORM_NAME);
    ...
    public void startFormActivity(String formName, String entityId, String metaData) {
        try {
            if (mBaseFragment instanceof BaseAypRegisterFragment) {
    ...
    public List<String> getViewIdentifiers() {
        return Arrays.asList(Constants.CONFIGURATION.ayp_ENROLLMENT);
    }
    ...
    protected void registerBottomNavigation() {
        ...
        if (bottomNavigationView != null) {
            ...
            BottomNavigationListener familyBottomNavigationListener = new AypBottomNavigationListener(this);
    ...
    public int getMenuResource() {
        return R.menu.bottom_nav_ayp;
    }

    @Override
    protected void initializePresenter() {
        presenter = new BaseAypRegisterPresenter(this, new BaseAypRegisterModel(), new BaseAypRegisterInteractor());
    }

    @Override
    protected BaseRegisterFragment getRegisterFragment() {
        return new BaseAypRegisterFragment();
    }
    ...
    @Override
    public AypRegisterContract.Presenter presenter() {
        return (AypRegisterContract.Presenter) presenter;
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK && requestCode == Constants.REQUEST_CODE_GET_JSON) {
            ...
            try {
                ...
                JSONArray fieldsOne = AypJsonFormUtils.fields(form, Constants.STEP_ONE);
    ...
    public void startClientProcessing() {
        try {
            ...
            AypUtil.getClientProcessorForJava().processClient(AypUtil.getSyncHelper().getEvents(lastSyncDate, BaseRepository.TYPE_Unprocessed));
