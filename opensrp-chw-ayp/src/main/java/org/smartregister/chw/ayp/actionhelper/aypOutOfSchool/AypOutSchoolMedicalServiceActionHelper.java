...
public class AypOutSchoolMedicalServiceActionHelper implements BaseAypVisitAction.aypVisitActionHelper {
    private MemberObject memberObject;
    protected String serviceStatus;
    protected String jsonPayload;
    private Context context;

    public AypOutSchoolMedicalServiceActionHelper(Context context, MemberObject memberObject) {
    ...
    public void onPayloadReceived(String jsonPayload) {
        try {
            ...
            this.serviceStatus = JsonFormUtils.getValue(payload, "received_hpv_vaccine");
        } catch (Exception e) {
            Timber.e(e);
        }
    }
