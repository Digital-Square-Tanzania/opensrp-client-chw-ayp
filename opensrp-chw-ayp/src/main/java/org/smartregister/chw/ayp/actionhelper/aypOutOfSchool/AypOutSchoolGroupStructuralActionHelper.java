...
public class AypOutSchoolGroupStructuralActionHelper implements BaseAypVisitAction.aypVisitActionHelper {
    private MemberObject memberObject;
    protected String serviceStatus;
    protected String jsonPayload;
    private Context context;

    public AypOutSchoolGroupStructuralActionHelper(Context context, MemberObject memberObject) {
    ...
    public void onPayloadReceived(String jsonPayload) {
        try {
            ...
            this.serviceStatus = JsonFormUtils.getValue(payload, "choose_economic_empowerment_services");
        } catch (Exception e) {
            Timber.e(e);
        }
    }
