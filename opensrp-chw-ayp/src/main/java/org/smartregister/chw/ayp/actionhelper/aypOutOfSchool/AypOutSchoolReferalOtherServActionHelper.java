...
public class AypOutSchoolReferalOtherServActionHelper implements BaseAypVisitAction.aypVisitActionHelper {
    private MemberObject memberObject;
    protected String serviceStatus;
    protected String jsonPayload;
    private Context context;

    public AypOutSchoolReferalOtherServActionHelper(Context context, MemberObject memberObject) {
    ...
    public void onPayloadReceived(String jsonPayload) {
        try {
            ...
            this.serviceStatus = JsonFormUtils.getValue(payload, "is_client_refered_to_the_facility");
        } catch (Exception e) {
            Timber.e(e);
        }
    }
