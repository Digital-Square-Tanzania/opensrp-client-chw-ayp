...
public class AypInSchoolFinancialLiteracyActionHelper implements BaseAypVisitAction.aypVisitActionHelper {
    private MemberObject memberObject;
    private String financialLiteracyConducted;
    protected String jsonPayload;
    private Context context;

    public AypInSchoolFinancialLiteracyActionHelper(Context context, MemberObject memberObject) {
