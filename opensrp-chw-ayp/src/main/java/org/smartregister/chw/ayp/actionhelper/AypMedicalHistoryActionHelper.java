...
public class AypMedicalHistoryActionHelper implements BaseAypVisitAction.aypVisitActionHelper {
    ...
    public AypMedicalHistoryActionHelper(Context context, MemberObject memberObject) {
