...
public class BaseAypRegisterFragmentPresenter implements AypRegisterFragmentContract.Presenter {

    protected WeakReference<AypRegisterFragmentContract.View> viewReference;
    ...
    public BaseAypRegisterFragmentPresenter(AypRegisterFragmentContract.View view, AypRegisterFragmentContract.Model model, String viewConfigurationIdentifier) {
    ...
    protected AypRegisterFragmentContract.View getView() {
...
//        implement
    ...
    public String getDueFilterCondition() {
        return " (cast( julianday(STRFTIME('%Y-%m-%d', datetime('now'))) -  julianday(IFNULL(SUBSTR(ayp_test_date,7,4)|| '-' || SUBSTR(ayp_test_date,4,2) || '-' || SUBSTR(ayp_test_date,1,2),'')) as integer) between 7 and 14) ";
    }
}
