...
public class AypOutSchoolSBCServiceActionHelper implements BaseAypVisitAction.aypVisitActionHelper {
    private MemberObject memberObject;
    protected String serviceStatus;
    protected String jsonPayload;
    private Context context;

    public AypOutSchoolSBCServiceActionHelper(Context context, MemberObject memberObject) {
