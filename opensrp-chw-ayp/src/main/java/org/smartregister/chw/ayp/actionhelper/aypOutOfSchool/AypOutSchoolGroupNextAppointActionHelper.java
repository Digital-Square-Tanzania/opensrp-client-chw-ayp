...
public class AypOutSchoolGroupNextAppointActionHelper implements BaseAypVisitAction.aypVisitActionHelper {
    private MemberObject memberObject;
    private String financialLiteracyConducted;
    protected String jsonPayload;
    private Context context;

    public AypOutSchoolGroupNextAppointActionHelper(Context context, MemberObject memberObject) {
