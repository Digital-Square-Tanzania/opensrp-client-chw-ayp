...
import org.smartregister.chw.ayp.util.ConfigHelper;
...
public class BaseAypRegisterFragmentModel implements AypRegisterFragmentContract.Model {

    @Override
    public RegisterConfiguration defaultRegisterConfiguration() {
        return ConfigHelper.defaultRegisterConfiguration(AypLibrary.getInstance().context().applicationContext());
    }
