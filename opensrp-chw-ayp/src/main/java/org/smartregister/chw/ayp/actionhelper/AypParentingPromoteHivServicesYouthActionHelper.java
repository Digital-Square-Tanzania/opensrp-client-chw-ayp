...
public class AypParentingPromoteHivServicesYouthActionHelper extends BaseAypParentingVisitActionHelper {

    public AypParentingPromoteHivServicesYouthActionHelper(Context context, MemberObject memberObject) {
        super(context, memberObject);
    }

    @Override
    protected String evaluateSubTitle(JSONObject jsonObject) throws JSONException {
        List<String> selections = getTranslatedValueList(jsonObject, "promote_hiv_services_youth");
    ...
    protected BaseAypVisitAction.Status evaluateStatus(JSONObject jsonObject) throws JSONException {
        return getValueList(jsonObject, "promote_hiv_services_youth").isEmpty()
