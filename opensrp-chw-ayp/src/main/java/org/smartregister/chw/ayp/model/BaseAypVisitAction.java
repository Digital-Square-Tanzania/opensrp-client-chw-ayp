...
import org.smartregister.chw.ayp.fragment.BaseAypVisitFragment;
 ...
 */
public class BaseAypVisitAction {
    ...
    private BaseAypVisitFragment destinationFragment;
    private String formName;
    private String jsonPayload;
    private String selectedOption;
    private aypVisitActionHelper aypVisitActionHelper;
    private Map<String, List<VisitDetail>> details;
    private Context context;
    private Validator validator;

    private BaseAypVisitAction(Builder builder) throws ValidationException {
        ...
        this.aypVisitActionHelper = builder.aypVisitActionHelper;
        ...
        try {
            if (StringUtils.isBlank(jsonPayload) && StringUtils.isNotBlank(formName)) {
                ...
                if (details != null && details.size() > 0) {
                    AypJsonFormUtils.populateForm(jsonObject, details);
                }

                jsonPayload = jsonObject.toString();
            }

            if (aypVisitActionHelper != null) {
                aypVisitActionHelper.onJsonFormLoaded(jsonPayload, context, details);
                String pre_processed = aypVisitActionHelper.getPreProcessed();
                ...
                String sub_title = aypVisitActionHelper.getPreProcessedSubTitle();
                if (StringUtils.isNotBlank(sub_title)) {
                    this.subTitle = sub_title;
                }

                ScheduleStatus status = aypVisitActionHelper.getPreProcessedStatus();
                if (status != null) {
    ...
    private void onPayloadReceivedNotifyHelper(String jsonPayload) {
        ...
        aypVisitActionHelper.onPayloadReceived(jsonPayload);

        String sub_title = aypVisitActionHelper.evaluateSubTitle();
        if (sub_title != null) {
            setSubTitle(sub_title);
        }

        String post_process = aypVisitActionHelper.postProcess(jsonPayload);
        if (post_process != null) {
            this.jsonPayload = aypVisitActionHelper.postProcess(jsonPayload);
        }

        aypVisitActionHelper.onPayloadReceived(this);
    }
    ...
    public BaseAypVisitFragment getDestinationFragment() {
        return destinationFragment;
    }

    public void setDestinationFragment(BaseAypVisitFragment destinationFragment) {
    ...
    public aypVisitActionHelper getaypVisitActionHelper() {
        return aypVisitActionHelper;
    }

    public void setaypVisitActionHelper(aypVisitActionHelper aypVisitActionHelper) {
        this.aypVisitActionHelper = aypVisitActionHelper;
    }
    ...
    public void evaluateStatus() {
        ...
        if (getaypVisitActionHelper() != null) {
            setActionStatus(getaypVisitActionHelper().evaluateStatusOnPayload());
        }
    }
    ...
    public interface aypVisitActionHelper {
         ...
         */
        void onPayloadReceived(BaseAypVisitAction aypVisitAction);
    }
    ...
    public static class Builder {
        ...
        public Builder withDestinationFragment(BaseAypVisitFragment destinationFragment) {
            this.destinationFragment = destinationFragment;
            return this;
        }
        ...
        public Builder withHelper(aypVisitActionHelper aypVisitActionHelper) {
            this.aypVisitActionHelper = aypVisitActionHelper;
            return this;
        }
        ...
        public BaseAypVisitAction build() throws ValidationException {
            return new BaseAypVisitAction(this);
        }
    }
