...
public class MemberObject implements Serializable {
    ...
    private String dateChwaypTest;
    private String feveraypChw;
    private String feverDuration;
    private String dateHfaypTest;
    private Date aypTestDate;
    private String aypTreat;
    private String famLlin;
    private String llin2Days;
    private String llinCondition;
    private String aypEduChw;
    ...
    private String aypFollowUpDate;
    ...
    public String getDateChwaypTest() {
        return dateChwaypTest;
    }

    public void setDateChwaypTest(String dateChwaypTest) {
        this.dateChwaypTest = dateChwaypTest;
    }

    public String getFeveraypChw() {
        return feveraypChw;
    }

    public void setFeveraypChw(String feveraypChw) {
        this.feveraypChw = feveraypChw;
    }
    ...
    public String getDateHfaypTest() {
        return dateHfaypTest;
    }

    public void setDateHfaypTest(String dateHfaypTest) {
        this.dateHfaypTest = dateHfaypTest;
    }

    public Date getaypTestDate() {
        return aypTestDate;
    }

    public void setaypTestDate(Date aypTestDate) {
        this.aypTestDate = aypTestDate;
    }

    public String getaypTreat() {
        return aypTreat;
    }

    public void setaypTreat(String aypTreat) {
        this.aypTreat = aypTreat;
    }
    ...
    public String getaypEduChw() {
        return aypEduChw;
    }

    public void setaypEduChw(String aypEduChw) {
        this.aypEduChw = aypEduChw;
    }
    ...
    public String getaypFollowUpDate() {
        return aypFollowUpDate;
    }

    public void setaypFollowUpDate(String aypFollowUpDate) {
        this.aypFollowUpDate = aypFollowUpDate;
    }
